		...
		<main>
			<div className="position-relative">
				<section className="section section-lg section-shaped pb-250">
					<div className={`shape shape-style-1 ${isDarkMode ? "bg-gradient-dark " : "bg-gradient-info"} `}>
						<span />
						<span />
						<span />
						<span />
					...
					<Container className="py-lg-md d-flex">
						<div className="col px-0">
							<Row>
								...
								<Col lg="6">
									<GreetingLottie animationPath={require("../assets/lottie/coding.json")} />
								</Col>
							</Row>
						</div>
					</Container>
